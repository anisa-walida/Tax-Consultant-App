...
import 'previous_client_detail.dart';

class PreviousClient extends StatefulWidget {
  final String uniqueKey;
  PreviousClient({required this.uniqueKey});

  @override
  State<PreviousClient> createState() => _PreviousClientState();
}

class _PreviousClientState extends State<PreviousClient> {
            ...
            Expanded(
              child: FirebaseAnimatedList(
                ...
                itemBuilder: (BuildContext context, DataSnapshot snapshot,
                  ...
                  if (guser['uniqueKey_consultant']==widget.uniqueKey && guser['check'] == "previous") {
  ...
  void navigateToDetailPage(String name, String email, String address,
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Previous_Client_Detail(
          name: name,
          email: email,
          address: address,
