...
import 'call_page_consultant.dart';

class TalkToClient extends StatefulWidget {
  final String consultant_userUid;
  TalkToClient({required this.consultant_userUid});

  @override
  State<TalkToClient> createState() => _TalkToClientState();
}

class _TalkToClientState extends State<TalkToClient> {
              ...
              child: FirebaseAnimatedList(
                ...
                itemBuilder: (BuildContext context, DataSnapshot snapshot,
                  ...
                  if (consultant['consultant_userUid'] ==
                    ...
                    return listItem(
                        consultant: consultant, onTap: navigateToDetailPage ,txt: "Current Client");
                  }
                  return Container();
                },
              ),
  ...
  void navigateToDetailPage(String uniqueKey) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ConsultantCall(
          uniqueKey: uniqueKey,
        ),
      ),
    );
