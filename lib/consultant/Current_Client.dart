...
import 'current_client_detail.dart';

class CurrentClient extends StatefulWidget {
  final String uniqueKey;
  CurrentClient({required this.uniqueKey});

  @override
  State<CurrentClient> createState() => _CurrentClientState();
}

class _CurrentClientState extends State<CurrentClient> {
            ...
            Expanded(
              child: FirebaseAnimatedList(
                ...
                itemBuilder: (BuildContext context, DataSnapshot snapshot,
                  ...
                  if (guser['uniqueKey_consultant']==widget.uniqueKey && guser['check'] == "current") {
  ...
  void navigateToDetailPage(String name, String email, String address,
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => Current_Client_Detail(
          name: name,
          email: email,
          address: address,
